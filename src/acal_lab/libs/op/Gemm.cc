...
void acal_lab::Gemm::execPerLayerNaiveQuant()
{
...
void acal_lab::Gemm::execPerOperationNaiveQuant()
{
    int index_A, index_B, index_C;
    int8_t temp_A[4] = {0}, temp_B[4] = {0};
...
void acal_lab::Gemm::execPerLayerAdvanceQuant()
{
    sQNT_INFO(qInfo->scaling_factor, qInfo->zero_point);
}

void acal_lab::Gemm::execPerOperationAdvanceQuant()
{
    sQNT_INFO(qInfo->scaling_factor, qInfo->zero_point);
}
