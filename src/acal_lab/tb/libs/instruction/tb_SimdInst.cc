...
bool acal_lab::tb::tb_sADDI8I8S_vv()
{
...
bool acal_lab::tb::tb_sADDI16I16S_vv()
{
...
bool acal_lab::tb::tb_sADDI8I8S_vx()
{
...
bool acal_lab::tb::tb_sADDI16I16S_vx()
{
...
bool acal_lab::tb::tb_sADDS_vv()
{
    return tb_sADDI8I8S_vv() & tb_sADDI16I16S_vv();
}
bool acal_lab::tb::tb_sADDS_vx()
{
    return tb_sADDI8I8S_vx() & tb_sADDI16I16S_vx();
}
bool acal_lab::tb::tb_sADDS()
{
    return tb_sADDS_vv() & tb_sADDS_vx();
}
...
bool acal_lab::tb::tb_sSUBI8I8S_vv()
{
    int8_t rs1[4], rs2[4], rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
    while (idx--)
...
bool acal_lab::tb::tb_sSUBI16I16S_vv()
{
    int16_t rs1[2], rs2[2], rd[2], rd_tb[2];
    int idx = TB_SIZE, cnt = 0;
    while (idx--)
...
bool acal_lab::tb::tb_sSUBI8I8S_vx()
{
    int8_t rs1[4], rd[4], rd_tb[4];
    int32_t rs2;
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sSUBI16I16S_vx()
{
    int16_t rs1[2], rd[2], rd_tb[2];
    int32_t rs2;
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sSUBS_vv()
{
    return tb_sSUBI8I8S_vv() & tb_sSUBI16I16S_vv();
}
bool acal_lab::tb::tb_sSUBS_vx()
{
    return tb_sSUBI8I8S_vx() & tb_sSUBI16I16S_vx();
}
bool acal_lab::tb::tb_sSUBS()
{
    return tb_sSUBS_vv() & tb_sSUBS_vx();
}
...
bool acal_lab::tb::tb_sPMULI8I16S_vv_L()
{
    int8_t rs1[4], rs2[4];
...
bool acal_lab::tb::tb_sPMULI8I16S_vv_H()
{
    int8_t rs1[4], rs2[4];
    int16_t rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sPMULI8I16S_vv_HL()
{
    int8_t rs1[4], rs2[4];
    int16_t rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sPMULI8I16S_vv_LH()
{
    int8_t rs1[4], rs2[4];
    int16_t rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sPMULI8I16S_vx_L()
{
    int8_t rs1[4];
    int16_t rd[4], rd_tb[4];
    int32_t rs2 = 0;
...
bool acal_lab::tb::tb_sPMULI8I16S_vx_H()
{
    int8_t rs1[4];
    int32_t rs2 = 0;
    int16_t rd[4], rd_tb[4];
...
bool acal_lab::tb::tb_sPMULI8I16S_vx_LH()
{
    int8_t rs1[4];
    int32_t rs2 = 0;
    int16_t rd[4], rd_tb[4];
...
bool acal_lab::tb::tb_sPMULI8I16S_vx_HL()
{
    int8_t rs1[4];
    int32_t rs2 = 0;
    int16_t rd[4], rd_tb[4];
...
// int8_t b[4])
bool acal_lab::tb::tb_sAMULI8I8S_vv_NQ()
{
    int8_t rs1[4], rs2[4], rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
    while (idx--)
...
// int8_t b[4])
bool acal_lab::tb::tb_sAMULI8I8S_vv_AQ()
{
    int8_t rs1[4], rs2[4], rd[4], rd_tb[4];
    int idx = TB_SIZE, cnt = 0;
    int sc = 0, zpt = 0;
...
// int8_t b)
bool acal_lab::tb::tb_sAMULI8I8S_vx_NQ()
{
    int8_t rs1[4], rd[4], rd_tb[4];
    int32_t rs2;
    int idx = TB_SIZE, cnt = 0;
...
// int8_t b[4])
bool acal_lab::tb::tb_sAMULI8I8S_vx_AQ()
{
    int8_t rs1[4], rd[4], rd_tb[4];
    int32_t rs2;
    int idx = TB_SIZE, cnt = 0;
...
bool acal_lab::tb::tb_sAMULI8I8S_vv()
{
    return tb_sAMULI8I8S_vv_NQ() & tb_sAMULI8I8S_vv_AQ();
}
bool acal_lab::tb::tb_sAMULI8I8S_vx()
{
    return tb_sAMULI8I8S_vx_NQ() & tb_sAMULI8I8S_vx_AQ();
}
bool acal_lab::tb::tb_sAMULI8I8S()
{
    return tb_sAMULI8I8S_vv() & tb_sAMULI8I8S_vx();
}