...
void acal_lab::tb::TB_Conv::execPerLayerNaiveQuant()
{
}
void acal_lab::tb::TB_Conv::execPerLayerAdvanceQuant()
{
}

void acal_lab::tb::TB_Conv::execPerOperationNaiveQuant()
{
}

void acal_lab::tb::TB_Conv::execPerOperationAdvanceQuant()
{
}
