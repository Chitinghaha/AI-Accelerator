...
bool acal_lab::tb::tb_MxPl()
{
    ...
    while (tb_idx--)
    {
        ...
        acal_lab::simd::MxPl(&data_1, &data_0, &mInfo, GENERAL).execute();
        acal_lab::scalar::MxPl(&data_1_Test, &data_0, &mInfo, GENERAL).execute();

        correct_cnt += acal_lab::tb::compare8(&data_1, &data_1_Test);
    }
